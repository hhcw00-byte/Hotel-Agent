...
function buildTripSuccess(segment, details = {}) {
  ...
  return {
    ...
    roomResults,
    diagnostics: {
      executionPlanMode: "trip_v2_real_submit",
...
function buildTripFailure(segment, failureInput) {
...
function throwTripError(code, stage, message, diagnostics = {}) {
